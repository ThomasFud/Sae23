...
//  Static page: planning, tools, per-member work, problems
$title = "Gestion de projet";
include 'header.php';
?>
<h1>Gestion de projet</h1>

<!-- Planning section, with the GANTT chart image -->
...
<!-- Collaboration tools used by the group -->
...
<!-- Issues encountered during the project and how they were solved -->
